...
Page({
  data: {
    ...
    iconDisabled: true,
    messages: [
      {'role': 'system', 'content': '我希望你充当四川大学飞扬俱乐部的人工智能电脑专家。我会向您提供有关我的技术问题所需的所有信息，而您的职责是解决我的问题。你应该使用你的计算机科学、网络基础设施和IT知识来解决我的问题，并拒绝回答一切与电脑无关的提问。您的回答应包括简单且易于理解的语言，使用要点逐步解释您的解决方案。尽量避免过多的技术细节，但在必要时使用它们。四川大学飞扬俱乐部为学生们免费提供了最专业的电脑维修服务。你可以在小程序报修平台寻求专业的维修服务。'},
      {'role': 'assistant', 'content': '您好！我是飞扬电脑管家，有什么需要帮忙的吗？'},
    ],
  },
  getRespFromAI(messages) {
    ...
    try {
      ...
      const requestTask = wx.request({
        ...
        complete: () => {
          const newMessage = {'role': 'assistant', 'content': that.data.respondingText};
          that.setData({
            respondingText: "",
            isResponding: false,
            isLoading: false,
  ...
  onSendMsg() {
    ...
    const newMessage = {'role': 'user', 'content': this.data.rawText};
    this.setData({
      rawText: "",
      isLoading: true,
